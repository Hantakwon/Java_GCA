...
public class StaticTest {
	public static void main(String[] args) {
		...
		Car granduer = new Car("그랜저", "검정색", 0);
		
		sonata.show();
		avante.show();
		granduer.show();
	
		// 클래스 메서드(정적 메서드)는 클래스 타입으로 참조 호출
		...
		System.out.println("1 + 2 : " + cal1.plus(1, 2));
		System.out.println("1 - 2 : " + cal1.minus(1, 2));
		System.out.println("2 * 3 : " + cal1.multi(2, 3));
		System.out.println("4 / 2 : " + cal1.div(4, 3));
	}
}
